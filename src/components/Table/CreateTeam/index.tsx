...
function createData(
  ...
  return { vəzifə, name, protein };
}

const rows = [
  createData('Front Developer', 'Ramil Qenberli', 4.0),
  createData('Back Developer', 'Mahir Israfilov', 4.3),
    ...
    <Paper>
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
          <TableHead>
            <TableRow>
              <TableCell className='borderDelete' align='left'>Vəzifə</TableCell>
              <TableCell className='borderDelete' align="inherit">Ad və soyad</TableCell>
          ...
          <TableBody>
            {rows.map((row, index) => (
              index % 2 == 0 ?
                ...
                >
                  <TableCell className='borderDelete' align='left'>
                    {row.vəzifə}
                  </TableCell>
                  <TableCell className='borderDelete' align="left">{row.name}</TableCell>
                  <TableCell className='borderDelete' align="right">{<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <TableRow className='B'
                  ...
                  sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                >
                  <TableCell className='borderDelete' component="th" scope="row">
                    {row.vəzifə}
                  </TableCell>
                  <TableCell className='borderDelete' align="left">{row.name}</TableCell>
                    <TableCell className='borderDelete' align="right">{<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
